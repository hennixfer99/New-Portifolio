...
function Projects() {
  ...
  function git4(){
    const redirect = window.open("https://github.com/hennixfer99/M3-ProjetoCapstone--Alex-Grupo3")
    return redirect
  }
  function git5(){
  ...
  function git6(){
    const redirect = window.open("https://github.com/Kenzie-Academy-Brasil-Developers/m5-sprint5-komercio-hennixfer99")
    return redirect
  }
  function project1(){
  ...
  function project5(){
    const redirect = window.open("https://recikle-projeto.herokuapp.com/api/")
    return redirect
  }
  function project6(){
    const redirect = window.open("https://komercio-generic-view-henrique.herokuapp.com/api/")
    return redirect
  }
